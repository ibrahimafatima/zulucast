    ...
    return (
      <React.Fragment>
        ...
        <section className="py-5">
          ...
          >
            <h3 className="text-uppercase underline fw-bolder">MOST POPULAR</h3>
            <div id="popular-movies-dots" className="full-slide-dots"></div>
            <ul id="popular-movies" className="slick-4 ps-0 mt-5 list-unstyled">
