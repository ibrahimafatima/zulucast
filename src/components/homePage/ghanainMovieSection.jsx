      ...
      <React.Fragment>
        ...
        <section className="py-5">
          ...
          >
            ...
            <div id="ghanaian-movies-dots" className="full-slide-dots"></div>
            <ul id="ghana-movies" className="slick-4 ps-0 mt-5 list-unstyled">
...
export default GhanainMovieSection;
